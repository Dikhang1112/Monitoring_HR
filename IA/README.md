...
This section provides the official Information Architecture (IA) and Sitemap for the **HR Management & Productivity Platform**, structured according to the full module hierarchy across **Home**, **People Management**, **Recruitment & ATS**, **Onboarding**, and **Offboarding**.
...
### 5. Organization & Department (Org Structure Tree & Roster)
- **HTML**: [`IA/html/people_management/OrgDepartment.html`](html/people_management/OrgDepartment.html)
- **JS**: [`IA/js/people_management/OrgDepartment.js`](js/people_management/OrgDepartment.js)

- **Features**:
  - Dual View Modes: Interactive Org Structure Tree View & Department Roster Table.
  - Interactive Org Tree Canvas with Zoom In/Out controls and multi-tier reporting hierarchy (Executive Board $\rightarrow$ Divisions $\rightarrow$ Sub-units).
  - Live Search & Location Branch filtering (Headquarters HCMC, Hanoi, Da Nang, Remote).
  - Slide-over Drawer for adding new departments & editing existing department parameters.
  - KPI Overview Cards tracking total departments, branches, headcount allocation, and manager span of control.
